...
- **1. create_idea** — `hypo_loop`
  - round_1
    - `chat/prompts/1_create_idea/round_1/1_gen_hypo.md` — 6 prompts
...
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `3_gen_art/` — 3 task(s)
      ...
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_experiment_1.md` — 5 prompts
  ...
  - round_2
    - `chat/prompts/2_test_idea/round_2/1_gen_strat.md` — 7 prompts
    - `2_gen_plan/` — 3 task(s)
    ...
    - `3_gen_art/` — 3 task(s)
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_dataset_1.md` — 5 prompts
    ...
    - `chat/prompts/2_test_idea/round_2/4_gen_paper_text.md` — 8 prompts
    - `chat/prompts/2_test_idea/round_2/5_review_paper.md` — 2 prompts
    - `chat/prompts/2_test_idea/round_2/6_upd_hypo.md` — 7 prompts
- **3. report_results** — `gen_paper_repo`
  ...
  - `2_gen_demo_art/` — 6 task(s)
    ...
    - `chat/prompts/3_report_results/2_gen_demo_art/gen_demo_art_dataset_2.md` — 3 prompts
    ...
    - `chat/prompts/3_report_results/2_gen_demo_art/gen_demo_art_experiment_1.md` — 3 prompts
